...
def block_level_layout():
    return dbc.Container(
        [html.Br(), html.Div(id="block-page-body")], fluid=True
    )
            ...
            html.Div(
                [
                    ...
                    html.P(
                        ...
                        "The Fire Risk Index (FRI) integrates the Fire Susceptibility Index (FSI) and the "
                        "Fire Weather Index (FWI)."
                    ),
                    html.P(
                        "Current fire weather conditions are derived from near-real-time meteorological data "
                        "and processed using the Canadian Fire Weather Index System through xclim."
                    ),
                    html.P(
                        "For short-term outlooks, the dashboard generates a 14-day projection using forecast "
                        "meteorological data processed sequentially so that fuel-moisture conditions evolve day by day."
                    ),
                    html.P(
                        "Projected Fire Risk Index values also include a short-term weather-adjusted "
                        "susceptibility modifier to reflect drying, wind stress, humidity reduction, and rainfall relief."
                    ),
                    html.P(
                        "These indicators should be interpreted as operational risk signals rather than exact "
